...
urlpatterns = [
    ...
    path(
        "releases/<int:release_id>/check/",
        views.release_check,
        name="release_check",
    ),
    path(
        "releases/<int:release_id>/build/",
        views.release_build,
        name="release_build",
    ),
    path(
    ...
    path(
        "builds/<int:build_id>/status/",
        views.build_status,
        name="build_status",
    ),
    path(
        "releases/<int:release_id>/verify/",
        views.release_verify,
        name="release_verify",
    ),
    path(
    ...
    path(
        "releases/<int:release_id>/cancel/",
        views.release_cancel,
        name="release_cancel",
    ),
    path(
